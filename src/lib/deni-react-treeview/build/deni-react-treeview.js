...
function _createComponentsChildren(treeview, parent, level, children) {
  var style = level > 1 && parent.props.item && parent.props.item.expanded && children && children.length >= 1 ? "sidebar-scroll" : null;
...
var DeniReactTreeViewItem = function (_React$Component) {
  ...
  _createClass(DeniReactTreeViewItem, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { style: style, className: _deniReactTreeviewItem2.default.getClassItem(treeview, item, level, selectRow), onMouseDown: _deniReactTreeviewItem2.default.treeviewItemContainerMouseDown.bind(this, this.props.treeview, selectRow) /* onDoubleClick={treeviewItemHelper.treeviewItemContainerDoubleClick.bind(this, treeviewItemHelper, this.props.treeview, selectRow)} */ },
        ...
        _react2.default.createElement(
          'div',
          { onMouseDown: _deniReactTreeviewItem2.default.treeviewItemExpandButtonMouseDown.bind(this, this.props.treeview, item), className: _deniReactTreeviewItem2.default.getClassIconAndText(treeview, item, selectRow) },
...
module.exports = {
    getClassItem: function getClassItem(treeview, item, level, selectRow) {
        ...
        if (item.isFolder) {
            if (item.expanded) classNames.push("folder-item-expanded");else classNames.push("folder-item");
        } else if (item.isLeaf) {
            if (item.expanded) classNames.push("leaf-item-expanded");else classNames.push("leaf-item");
        }
...
module.exports = function (scope) {
  ...
  return {
    ...
    unselectItem: function unselectItem() {
      _deniReactTreeviewApi2.default.unselectItem(scope);
    },
    //
    //
    //
...
module.exports = {
  ...
  unselectItem: function unselectItem(scope) {
    scope.setState({
      selectedItem: undefined
    });
  }
